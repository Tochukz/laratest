<template>
   <div class="row">
       <div class="col-sm-6">
           <h2>Chat Using Pusher <button class="btn btn-secondary" @click="clear">clear</button></h2>
           <div>
           ...
           <form @submit.prevent="sendMessage" class="form">
               ...
               <div class="form-group">
                   <button class="btn btn-secondary form-control">Send</button>
               </div>
           </form>
       </div>
   </div>
...
export default {
  ...
  created() {
    ...
    var pusher = new Pusher('beb3049693cc846ffc2c', {
      cluster: 'ap2'
    });
